...
class _HomePageState extends State<HomePage> {
  ...
  updateAvailableNearbyOnlineDriversOnMap() {
    ...
    for (OnlineNearbyDrivers eachOnlineNearbyDriver in ManageDriversMethods.nearbyOnlineDriversList) {
      ...
      print("Driver Name: ${eachOnlineNearbyDriver.nameDriver}PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPppppppppppppppppp");
  ...
  Future<void> fetchDriverDetails(BuildContext context, List<String> driverKeys) async {
    ...
    for (String key in driverKeys) {
      ...
      try {
        ...
        //  driverRatings: (driverData["averageRating"] as num).toDouble().toStringAsFixed(1),
